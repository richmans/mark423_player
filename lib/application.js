...
function mark423_check_parameters(options){
  ...
  if (typeof options['highlight_color'] === 'undefined') return options['highlight_color'] = '#DD4B39';
  if (typeof options['font_color'] === 'undefined') return options['font_color'] = '#333333';
  if (typeof options['background_color'] === 'undefined') return options['background_color'] = '#f5f5f5';
