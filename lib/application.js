...
function mark423_update_colors(options){
  ...
  document.querySelector('div#mark423-player div.jp-play-pause a.jp-play').style.color = highlight;
  document.querySelector('div#mark423-player div.jp-play-pause a.jp-pause').style.color = highlight;
  ...
  document.querySelector('div#mark423-player div.jp-eject a').style.color = highlight;
  document.querySelector('div#mark423-player div.jp-volume-bar-value').style.backgroundColor = highlight;
  document.querySelector('div#mark423-player div.jp-mute').style.color = highlight;
  document.querySelector('div#mark423-player div.jp-unmute').style.color = highlight;
